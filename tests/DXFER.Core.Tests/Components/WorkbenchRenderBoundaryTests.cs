...
public sealed class WorkbenchRenderBoundaryTests
{
    ...
    public void SyncLaunchUsesProductionToolGroups()
    {
        ...
        source.Should().NotContain("private IReadOnlyList<WorkbenchToolGroup> ToolGroups => ProductionToolGroups;");
    ...
    [Fact]
    public void MainLayoutKeepsDevMenuSplitWithoutPrototypeLabels()
    {
        ...
        source.Should().Contain("WorkbenchCommandId.LoadSample");
        source.Should().Contain("WorkbenchCommandId.Line");
