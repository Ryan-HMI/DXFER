...
| UT-SOLVER-007 | Persistent dimension graphics/anchors travel with geometry after the driving dimension value has been edited. | USER-FAILED | OPEN | OPEN | Latest rotated/dragged geometry screenshots logged; queued behind active Fillet/Chamfer work |
